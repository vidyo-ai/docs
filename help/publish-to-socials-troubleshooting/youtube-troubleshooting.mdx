...
description: "YouTube channel not showing in quso.ai? Pick the right Google account, check brand channels, and reauthorize with the channel selected."
---
...
- To create a channel, click your profile in YouTube and select **Create a Channel**, or use this link: [Create YouTube Channel](https://m.youtube.com/create_channel).
