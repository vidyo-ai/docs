...
description: "Use AI Clips in quso.ai to turn a podcast, webinar, or long video into short captioned clips. Upload, review the picks, edit, and export."
---
...
From the [Quso.ai](https://quso.ai) **Home Page**, click on the **AI Clips** option.
...
With just a few simple steps, you can generate high-impact clips that elevate your content strategy and save you hours of editing time. Dive in, experiment with settings, and let [Quso.ai](https://quso.ai)’s AI do the heavy lifting—so you can focus on publishing more, faster.
