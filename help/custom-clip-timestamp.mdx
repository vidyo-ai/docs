---
title: "Custom Clip Using Timestamps"
description: "Make a custom clip in quso.ai by typing the start and end timestamps yourself instead of using the AI picks. Works on any uploaded video."
mode: "wide"
---
