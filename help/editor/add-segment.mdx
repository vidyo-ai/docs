...
description: "Extend a clip or remove part of it in the quso.ai editor by adding or deleting segments of the source video. Useful when the AI cut too early."
---

Want to show more of your video content? You can **extend the end time** of a clip in Quso.ai’s editor by just a few simple steps. This is useful when trimming down from a longer video, but deciding to include a little more footage.
