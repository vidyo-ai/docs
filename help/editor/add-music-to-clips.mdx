...
description: "Add music to a video clip in quso.ai from the stock library or your own audio file, then set volume and trim it to the clip length."
---
...
1. **Open the Editor**\
   Head to the clip you want to edit and open it in the [Quso.ai](https://quso.ai) editor.
