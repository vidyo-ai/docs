...
description: "Use the AI influencer generator in quso.ai. Write or generate a script, pick an avatar and voice, and render a talking-head video."
---
...
6. **Generate the Video**\
   Hit **“Generate Video”**—[Quso.ai](https://quso.ai) will process your input and render the avatar presentation.
7. **Review & Edit**\
