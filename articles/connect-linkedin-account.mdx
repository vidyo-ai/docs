...
3. **Login to LinkedIn**\
   ...
   <img
     ...
     style={{ width:"75%" }}
   />
4. **Accept Authorization Permissions**\
   ...
   <img
     ...
     style={{ width:"80%" }}
   />
5. **Select Company or Personal LinkedIn Account**\
...
<Info>
  Analytics are only available for Linkedin Pages right now. Linkedin does not support fetching analytics from personal profiles.
</Info>